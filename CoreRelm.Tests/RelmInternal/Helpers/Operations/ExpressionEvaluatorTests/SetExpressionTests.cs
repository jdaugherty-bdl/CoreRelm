...
namespace CoreRelm.Tests.RelmInternal.Helpers.Operations.ExpressionEvaluatorTests
{
    public class SetExpressionTests
    {
        ...
        public void TestExpressionEvaluatorSet_MultipleFields_ReturnsProperSql()
        {
            ...
            // Act
            var result = evaluator.EvaluateSet([new RelmExecutionCommand(Command.Set, predicate.Body)]
                , queryParameters);
        ...
        public void TestExpressionEvaluatorSet_SetWithWhere_ReturnsProperSql()
        {
            ...
            result += evaluator.EvaluateSet([new RelmExecutionCommand(Command.Set, predicate.Body)]
                , queryParameters);
        ...
        public void TestExpressionEvaluatorSet_Nothing_ThrowsNotSupportedException()
        {
            ...
            // Act & Assert
            Assert.Throws<NotSupportedException>(() => evaluator.EvaluateSet([new RelmExecutionCommand(Command.Set, predicate.Body)]
                , queryParameters));
        }
    }
}
