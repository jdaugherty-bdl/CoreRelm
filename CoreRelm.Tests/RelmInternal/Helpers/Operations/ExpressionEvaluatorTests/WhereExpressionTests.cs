...
namespace CoreRelm.Tests.RelmInternal.Helpers.Operations.ExpressionEvaluatorTests
{
    public class WhereExpressionTests
    {
        ...
        public void TestExpressionEvaluatorWhere_Equalities_Equals_String_Variable()
        {
            ...
            // Act
            var result = evaluator.EvaluateWhereNew([new RelmExecutionCommand(Command.Where, predicate)]
                , queryParameters);
        ...
        public void TestExpressionEvaluatorWhere_CallExpressionRight_Select()
        {
            ...
            {
                new() { Id = 0, InternalId = "TEST1" },
                new() { Id = 1, InternalId = "TEST2" }
            }
        ...
        public void TestExpressionEvaluatorWhere_AnyOneComparison()
        {
            var objectList = new List<ComplexTestModel>
            {
                new() { TestColumnInternalId = "00000000-0000-0000-0000-000000000000", TestColumnNoAttributeArguments = "0" },
                new() { TestColumnInternalId = "00000000-0000-0000-0000-000000000001", TestColumnNoAttributeArguments = "1" }
            };
        ...
        public void TestExpressionEvaluatorWhere_AnyTwoComparisons_AndAlso()
        {
            ...
            var objectCompareList = new string[][]
            {
                ["00000000-0000-0000-0000-000000000000", "0", "a"],
                ["00000000-0000-0000-0000-000000000001", "1", "b"],
