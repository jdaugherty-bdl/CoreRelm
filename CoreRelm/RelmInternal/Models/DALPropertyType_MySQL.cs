...
namespace CoreRelm.RelmInternal.Models
{
    internal class DALPropertyType_MySQL
    {
        ...
        private static readonly IEnumerable<Tuple<string, MySqlDbType, Type, int>> MySqlTypeConverter = new List<Tuple<string, MySqlDbType, Type, int>>
        {
            ...
            new Tuple<string, MySqlDbType, Type, int>("binary", MySqlDbType.Binary, typeof(byte[]), -1),
            new Tuple<string, MySqlDbType, Type, int>("varbinary", MySqlDbType.VarBinary, typeof(byte[]), -1),
            new Tuple<string, MySqlDbType, Type, int>("tinyblob", MySqlDbType.TinyBlob, typeof(string), -1),
            new Tuple<string, MySqlDbType, Type, int>("mediumblob", MySqlDbType.MediumBlob, typeof(string), -1),
            new Tuple<string, MySqlDbType, Type, int>("longblob", MySqlDbType.LongBlob, typeof(string), -1),
            new Tuple<string, MySqlDbType, Type, int>("enum", MySqlDbType.Enum, typeof(string), -1),
            new Tuple<string, MySqlDbType, Type, int>("set", MySqlDbType.Set, typeof(string), -1),
