...
using static CoreRelm.GlobalEnums;
...
namespace CoreRelm.RelmInternal.Helpers.Operations
{
    internal class TableOperationsHelper
    {
        ...
        {
            var tableName = TableName ?? ForceType.GetCustomAttribute<RelmTable>()?.TableName ?? throw new CustomAttributeFormatException(CoreUtilities.NoDalTableAttributeError);
