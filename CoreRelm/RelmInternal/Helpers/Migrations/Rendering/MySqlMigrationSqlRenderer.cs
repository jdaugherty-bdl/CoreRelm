...
namespace CoreRelm.RelmInternal.Helpers.Migrations.Rendering
{
        ...
        ILogger<MySqlMigrationSqlRenderer>? log = null) : IRelmMigrationSqlRenderer
    {
        ...
        public string Render(MigrationPlan plan, MySqlRenderOptions? options = null)
        {
            ...
            var headerString = MigrationHeaderFormatter.BuildHeader(header, plan.MigrationType.ToString(), plan.DatabaseName, plan.StampUtc, safeName, plan.MigrationFileName, null);
