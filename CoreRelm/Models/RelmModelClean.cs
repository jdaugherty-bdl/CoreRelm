...
namespace CoreRelm.Models
{
    ...
    /// </summary>
    /// <remarks>The <see cref="RelmModelClean"/> class serves as a foundational class for entities, offering
    /// features such as: <list type="bullet"> <item>Data population from database
    ...
    public class RelmModelClean : IRelmModelClean
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the RelmModelClean class.
        /// </summary>
        public RelmModelClean() { }
        ...
        public RelmModelClean(IRelmModel fromModel)
        {
        ...
        public RelmModelClean(DataRow modelData, string? alternateTableName = null)
        {
        ...
        public virtual IRelmModel ResetWithData(DataRow modelData, string? alternateTableName = null)
        {
        ...
        public dynamic GenerateDTO(IEnumerable<string>? includeProperties = null, IEnumerable<string>? excludeProperties = null, string? sourceObjectName = null, Func<IRelmModel, Dictionary<string, object>>? getAdditionalObjectProperties = null, int iteration = 0)
        {
            ...
            */
            ...
            foreach (var property in baseRefType.GetRuntimeProperties())
            {
                ...
                if (iteration == 0 && getAdditionalObjectProperties != null)
                {
                    var additionalProperties = getAdditionalObjectProperties((IRelmModel)this)
                        ?.Where(x => !propertyStringValues.ContainsKey(x.Key) && !(excludeProperties?.Contains(x.Key) ?? false))
                        .ToList();
