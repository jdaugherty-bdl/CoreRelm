...
namespace CoreRelm.Interfaces.RelmQuick
{
    ...
    /// threads.</remarks>
    [Obsolete("IRelmQuickContext is deprecated and will be removed in future versions. Please use IRelmContext(autoInitializeDataSets: false, autoVerifyTables: false) instead.")]
